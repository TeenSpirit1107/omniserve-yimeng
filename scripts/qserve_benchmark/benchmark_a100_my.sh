...
# Benchmark Llama-3-8B-Instruct (adjusted for A40 with 46GB memory)
# MODEL=... Llama-3-8B...
MODEL=/local/ymteng/models/Llama-3-8B-Instruct-QServe
...
# Comment out other models since you don't have them
